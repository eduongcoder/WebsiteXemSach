...
const NovelCard = ({ idNovel }) => {
    ...
    return (
        <section className="bg-gradient-to-r from-yellow-200 to-orange-500 dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
                <div className="lg:-mx-6 lg:flex lg:items-center">
                    ...
                    <div className="mt-8 lg:w-1/2 lg:px-6 lg:mt-0">
                        ...
                        <h1 className="text-2xl font-semibold  text-sky-500 dark:text-white lg:text-3xl lg:w-96">
                        {novel.nameNovel}
                        </h1>

                        <p className="max-w-lg mt-6 text-sky-500 dark:text-gray-400">
                        ...
                        <p className="text-sky-600 dark:text-gray-300">
