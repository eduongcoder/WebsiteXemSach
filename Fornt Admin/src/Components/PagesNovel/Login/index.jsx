                            ...
                            <div className="p-4">
                                ...
                                >
                                    ...
                                    <div className="mt-4 flex justify-center space-x-4">
                                        <button
                                            type="button"
                                            className="flex justify-center items-center w-12 h-12 bg-blue-600 hover:bg-blue-700 rounded-full text-white"
                                        >
                                            <FaFacebook />
                                        </button>
                                        <button
                                            type="button"
                                            className="flex justify-center items-center w-12 h-12 bg-red-600 hover:bg-red-700 rounded-full text-white"
                                        >
                                            <FaGoogle />
                                        </button>
                                    </div>
