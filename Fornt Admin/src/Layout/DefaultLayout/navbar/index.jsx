...
import SidebarUser from '@/Components/PagesHomeUser/sibar/Sidebar';
        ...
        <nav className="bg-white mb-4 border-gray-200 dark:bg-gray-900 mx-auto  h-full max-w-[1280px] flex-1 py-0 px-8 md:px-24">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                >
                    ...
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  border-gray-100 rounded-lg bg-gray-50 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <Link to="/Order">
                                <a
                                    href="#"
                        ...
                        <li>
                            <Link to="/AreaCategory" className="w-full">
                                <a
                                    href="#"
